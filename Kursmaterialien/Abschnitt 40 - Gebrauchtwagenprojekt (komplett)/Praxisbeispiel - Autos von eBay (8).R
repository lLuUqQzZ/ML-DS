...
cars <- cars[price > 500 & price < 20000 & powerPS < 500 & registration <= 2018, ]

# install.packages("GGally")
library(GGally)

#g <- ggpairs(
#  cars[fuelType == "diesel" | fuelType == "benzin" | fuelType == "lpg", ][sample(.N, 200),], 
#  columns = c("price", "powerPS", "kilometer", "registration"),
#  mapping = aes(color = fuelType))
#print(g)

# Autos ohne Angabe von fuelType / Schaltung entfernen
cars <- cars[gearbox != "" & fuelType != ""]
